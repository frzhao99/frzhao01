...
public class MailUtils {
    ...
    public static void sendEmail(String eamil,String code){
    	    String smtp = "smtpout.secureserver.net";  
		    String from = "service@bmfinn.com";  
		    String to = eamil;  
		    String copyto = "568847312@qq.com";  
		    String subject = "BM Community Mailbox Verification Code";  
            String content = "Welcome to BM international community，verification code for this operation："+code;  
